...
pb = Pushbullet('o.pda35M8U1tRW1oIzpiBJrFwfoJv92Od9')

driver = webdriver.Chrome('C:/Python34/chromedriver/chromedriver')

#TODO customize these
tourney = "Smash Summit 9"
url = 'https://smash.gg/tournament/smash-summit-9/events/melee-singles/brackets/715476/1156900'
#url = 'https://smash.gg/tournament/genesis-7-1/events/melee-doubles/brackets/719810/1162853'
#url = 'https://smash.gg/tournament/genesis-7-1/events/melee-singles/brackets/719807/1162820'
#url = 'https://smash.gg/tournament/mango-s-birthday-bash-red-bull-adrenalan/events/melee-singles/brackets/711519/1151656'
#url = 'https://smash.gg/tournament/the-big-house-9/events/melee-singles/brackets/671281/1097099'
#url = 'https://smash.gg/tournament/capcom-cup-2019-sfvae-last-chance-qualifier/events/capcom-cup-2019-sfvae-last-chance-qualifier/brackets/642922/1056376'
...
top6  = [WF,GF,GF,LQ,LQ,LS,LF]
top62 = [WS,WS,WF,GF,GF,LQ,LQ,LS,LF]
...
if len(matchHTML) == len(top6)-1 or len(matchHTML) == len(top6):
    top = top6
elif len(matchHTML) == len(top62)-1 or len(matchHTML) == len(top62):
    top = top62
...
if not test:
    ...
    while count < 9:
        ...
        for match in matchHTML:
            ...
            # move on if no GF2
            if extra and top[i] == GF and top[i-1] == GF:
                i += 1
